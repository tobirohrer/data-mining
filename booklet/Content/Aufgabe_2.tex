...
\end{align*}
\noindent
Wobei für $db_{1}$ statt $X$ wieder 1 eingesetzt wird.\\
\noindent \hspace*{7mm}
In Anhang \ref{app:ergaenzung_booklet_2} ist die ausführliche mathematische Ausarbeitung des beschriebenen Vorgehens zu finden. Zusätzlich findet sich in Anhang \ref{app:quellcode_booklet_2} die dazugehörige Python-Implementierung.
